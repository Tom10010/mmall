...
//        User user = (User)session.getAttribute(Const.CURRENT_USER);
    ...
    @ResponseBody
    public ServerResponse list(HttpSession session, HttpServletRequest request, @RequestParam(value = "pageNum", defaultValue = "1")int pageNum, @RequestParam(value = "pageSize", defaultValue = "10")int pageSize){
//        User user = (User)session.getAttribute(Const.CURRENT_USER);
...
//        User user = (User)session.getAttribute(Const.CURRENT_USER);
    ...
    public Object alipayCallback(HttpServletRequest request){
        ...
        try {
            boolean alipqyRSACheckV2 = AlipaySignature.rsaCheckV2(params, Configs.getAlipayPublicKey(), "utf-8", Configs.getSignType());
            if(!alipqyRSACheckV2){
