...
//        User user = (User)session.getAttribute(Const.CURRENT_USER);
    ...
    public ServerResponse<String> forgetCheckAnswer(String username, String question, String answer){
        return iUserService.ckeckAnswer(username, question, answer);
    }
...
//        User currentCuser = (User)session.getAttribute(Const.CURRENT_USER);
        ...
        if(response.isSuccess()){
            ...
            RedisShardedPoolUtil.setEx(loginToken, JsonUtil.obj2String(response.getDate()), Const.RedisCacheExTime.REDIS_SESSION_EXTIME);
        }
        return response;
    }
